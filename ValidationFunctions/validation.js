const validation = {
  ...
  website: {
    ...
    format: /^((https+|http+|ftp|smtp):\/\/){0,1}(?!(www\.)?(snapchat\.?|instagram\.?|youtube\.?|youtu.be|facebook\.?|fb.me|whatsapp\.?|wa.me|api.whatsapp\.?))[a-z0-9_-]{1,63}\.[a-z]{2,}(\/?[a-zA-Z0-9#]+(\.[a-z]{2,})*(\\?[?;&a-z\\d%_~+=-]*)?)*\/?$/i,
    presence: { allowEmpty: false },
  },
  url: {
