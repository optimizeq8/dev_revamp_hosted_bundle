...
public class AppConstants {
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
      ...
      embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@saadiya.kazi/optimize_app", "assets://shell-app-manifest.json", "application/json"));
      embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40saadiya.kazi%2Foptimize_app%2F0.3.330%2F2b8792e525f958beb00cc5e6e0448e52-36.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
