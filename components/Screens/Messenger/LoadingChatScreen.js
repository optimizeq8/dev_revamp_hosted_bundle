...
class LoadingChatScreen extends React.Component {
	...
	componentDidUpdate(prevProps) {
		if ((!prevProps.loading && this.props.loading) || (!prevProps.loading_con && this.props.loading_con)) {
		...
		return (
			<SafeAreaView style={styles.safeAreaContainer} forceInset={{ bottom: 'never', top: 'always' }}>
				...
				<Container style={[styles.container]}>
					<Header closeButton={true} title={'Support'} navigation={this.props.navigation} />
					<View style={styles.flexView}>
						...
						/>
						<Text style={styles.connectingAgentText}>Connecting you to Your Agent</Text>
					</View>
