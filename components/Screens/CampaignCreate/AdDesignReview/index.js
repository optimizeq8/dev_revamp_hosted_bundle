				...
				<Container style={styles.container}>
					<Header iosBarStyle={'light-content'} style={styles.header}>
						<Body style={styles.headerBody}>
							<Title style={styles.brandName}>{this.props.navigation.state.params.brand_name}</Title>
					...
					<Content padder scrollEnabled={false} contentContainerStyle={styles.content}>
							...
							<View style={styles.mainCard}>
								...
								>
									...
									>
										{destination !== 'APP_INSTALL' &&
											...
											destination !== 'BLANK' && (
												<View
													style={[styles.iconArrowUp, { paddingRight: 0, marginBottom: 5 }]}
												>
													<ArrowUpIcon />
												</View>
											)}
										...
										>
											{this.props.navigation.state.params.call_to_action !== 'BLANK'
												? startCase(toLower(this.props.navigation.state.params.call_to_action))
												: ''}
										</Text>
									</View>
								...
								{adType === 'CollectionAd' && (
									<Animatable.View
										...
										style={[styles.bottomView, globalStyles.transparentBackgroundColor]}
									>
										{collection}
									</Animatable.View>
								)}
								{destination === 'APP_INSTALL' && (
									...
									>
										...
										<View style={styles.textContainerBottom}>
											...
											<Text
												numberOfLines={1}
												style={[globalStyles.grayTextColor, styles.headlineBottomText]}
											>
												{this.props.navigation.state.params.headline}
											</Text>
										</View>
										<Button style={[styles.getButton, globalStyles.darkGrayBackgroundColor]}>
