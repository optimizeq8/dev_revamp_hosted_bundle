			...
			if (objective === 'LEAD_GENERATION')
				menu = (
					<Website
						...
						_changeDestination={_changeDestination}
						navigation={this.props.navigation}
						collectionAdLinkForm={this.props.navigation.getParam('collectionAdLinkForm')}
					/>
				);
			else if (objective === 'VIDEO_VIEWS') {
				menu = <Long_Form_Video _changeDestination={_changeDestination} navigation={this.props.navigation} />;
			} else if (objective.toLowerCase().includes('app')) {
				menu = <App_Install _changeDestination={_changeDestination} navigation={this.props.navigation} />;
			} else if (objective === 'WEB_CONVERSION') {
				menu = <WhatsApp _changeDestination={_changeDestination} navigation={this.props.navigation} />;
			}
		}
		...
		return (
			<SafeAreaView style={styles.container} forceInset={{ top: 'always' }}>
				...
				<Container style={styles.container}>
					<CustomeHeader closeButton={false} navigation={this.props.navigation} />
