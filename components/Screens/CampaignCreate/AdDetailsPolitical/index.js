...
class AdDetails extends Component {
  ...
  handleMultipleCountrySelection = () => {
    ...
    if (!this.editCampaign) {
      ...
      let minValueBudget = 300 * this.state.campaignInfo.targeting.geos.length;
      ...
      this.setState(
        ...
        async () => {
          if (this.props.data.hasOwnProperty("campaignInfo")) {
            ...
            let minValueBudget = 300 * rep.targeting.geos.length;
  ...
  _handleSubmission = () => {
    ...
    if (
      ...
      // }
      delete rep.targeting.demographics;
      if (
    ...
    if (!this.editCampaign) {
      this.props.saveCampaignSteps(
        this.props.adType === "StoryAd"
          ...
          : ["Dashboard", "AdObjective", "AdDesign", "AdDetailsPolitical"]
      );
    }
  ...
  render() {
    ...
    switch (this.state.sidemenu) {
      ...
      case "selectors": {
        menu = (
          <MultiSelectSections
            screenProps={this.props.screenProps}
            countries={[{ label: "Kuwait", value: "kw" }]}
    ...
    return (
      <View style={{ height: "100%", backgroundColor: "#F8F8F8" }}>
        ...
        <StatusBar
          barStyle={
            this.editCampaign || Platform.OS === "android"
              ? "dark-content"
              : "default"
          }
