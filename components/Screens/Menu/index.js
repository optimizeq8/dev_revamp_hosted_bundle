...
import { View, Animated, Easing, TouchableOpacity, BackHandler, ScrollView } from 'react-native';
	...
	render() {
		return (
			<Container style={[styles.menuModal]}>
				<Background style={[styles.background]} width={widthPercentageToDP(85)} height={hp(61)} />
				{/* <TouchableOpacity
          onPress={() => {
          ...
          <Icons.LogoutIcon style={styles.icons} />
				...
				<View style={styles.menuContainer}>
					...
					<ScrollView contentContainerStyle={styles.scrollViewContainer}>
						...
						>
							<Icon name="security" type="MaterialIcons" style={[styles.icons]} />
						...
						<TouchableOpacity
							onPress={() => {
								this.props.clearPushToken(this.props.navigation, this.props.userInfo.userid);
							}}
							style={styles.options}
						>
							<Icons.LogoutIcon style={[styles.icons]} />
						...
						<Text style={styles.version}>
							Version:{Constants.manifest.version}13/
							{Constants.manifest.ios.buildNumber}/{Constants.manifest.android.versionCode}
						</Text>
					</ScrollView>
				</View>
...
const mapDispatchToProps = dispatch => ({
	clearPushToken: (navigation, userid) => dispatch(actionCreators.clearPushToken(navigation, userid)),
	createBusinessAccount: account => dispatch(actionCreators.createBusinessAccount(account)),
