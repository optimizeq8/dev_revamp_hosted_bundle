...
class MainForm extends Component {
	...
	render() {
		...
		return (
			<SafeAreaView forceInset={{ bottom: 'never', top: 'always' }} style={styles.safeAreaViewContainer}>
				<LinearGradient
...
const mapDispatchToProps = dispatch => ({
	login: (userInfo, navigation) => dispatch(actionCreators.login(userInfo, navigation)),
	resetRegister: () => dispatch(actionCreators.resetRegister()),
	checkForExpiredToken: navigation => dispatch(actionCreators.checkForExpiredToken(navigation)),
});
