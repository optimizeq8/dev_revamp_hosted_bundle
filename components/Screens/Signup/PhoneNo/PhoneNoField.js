	...
	render() {
		return (
			<>
				...
				>
					<TouchableOpacity style={styles.flagTouchableArea} onPress={this.onPressFlag} />
					<Icon
						name="arrow-drop-down"
						type="MaterialIcons"
						style={[
							styles.flagIcon,
							this.props.invite ? globalStyles.whiteTextColor : globalStyles.transparentTextColor,
						]}
					/>
					<PhoneInput
						...
						textStyle={{
							...
							borderBottomColor: this.props.invite ? '#0000' : this.props.valid ? '#5F5F5F' : 'red',
